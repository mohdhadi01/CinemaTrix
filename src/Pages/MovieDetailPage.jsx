...
function DetailPage(props) {
    ...
    const MovieApi = `https://api.themoviedb.org/3/movie/${IdValue}?language=en-US&api_key=a122cee36b1bc254ee171ee36a29bb98&append_to_response=credits,videos,similar`
    useEffect(() => {
        setIdValue(id);
            ...
            <div className="detailContainer" >
                ...
                <div className="DetailDiv">
                    ...
                    <div className="rightDetail">
                        <h1 className='detailTitle'>{MovieDetail ? <>{MovieDetail.original_title}</> : null}</h1>
                        ...
                        <h3 className='DetailOverview'>{MovieDetail?.overview ? <>{MovieDetail.overview}</> : null}</h3>
